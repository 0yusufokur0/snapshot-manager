...
- **Two snapshot types** — `system` (excluding /home) and `full` (including /home)
...
# Full backup (includes /home)
sudo snapshot-manager create full

# With a description
sudo snapshot-manager create system "Before nginx upgrade"
```
...
# Delete a snapshot
sudo snapshot-manager delete system_2026-03-08_14-30-00

# Lock (protect from auto-cleanup)
sudo snapshot-manager lock system_2026-03-08_14-30-00

# Unlock
sudo snapshot-manager unlock system_2026-03-08_14-30-00

# Compare two snapshots
sudo snapshot-manager diff system_2026-03-01_02-00-00 system_2026-03-08_02-00-00

# Restore a single file
sudo snapshot-manager restore-file system_2026-03-08_14-30-00 /etc/nginx/nginx.conf

# Verify snapshot integrity
sudo snapshot-manager verify system_2026-03-08_14-30-00
...
The GUI provides a graphical interface for all operations including snapshot creation with real-time progress, settings management, and disk migration.
